...
($n_\epsilon$) and the median absolute deviation from the true values as a
...
The two evaluation metrics were calcualted for each logger and for each
...
quantify the relative error introduced from each source of error.

...
knitr::include_graphics("../output/figures/sources_of_error_scatter_plot_panel.pdf")
...
knitr::include_graphics("../output/figures/bootstrap_correction_timeseries_linegraph_and_ribbon_panel.pdf")
```
